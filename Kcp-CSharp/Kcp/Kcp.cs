...
namespace KCP
{
    ...
    public sealed unsafe class Kcp : IDisposable
    {
        ...
        {
            ref var dst = ref buffer[0];
            return ikcp_recv(_kcp, (byte*)dst, buffer.Length);
        }
        ...
        {
            ref var dst = ref buffer[0];
            return ikcp_recv(_kcp, (byte*)dst, length);
        }
        ...
        /// <param name="interval">Interval</param>
        /// <param name="resend">Resend</param>
        ...
        /// </summary>
        /// <param name="fastlimit">Fast fast acknowledge limit</param>
